...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare('INSERT INTO payments (patient_id, amount, payment_date, method, notes, receipt_no, created_by) VALUES (?, ?, ?, ?, ?, ?, ?)');
    $stmt->execute([$patientId, $amount, $date, $method, $notes, $receiptNo, current_user()['id']]);
}
...
<table>
    <thead><tr><th>Date</th><th>Patient</th><th>Amount</th><th>Method</th><th>Receipt</th><th>Invoice</th></tr></thead>
    <tbody>
    <?php foreach ($payments as $pay): ?>
        <tr>
            ...
            <td><a class="btn secondary" href="../invoice.php?id=<?php echo $pay['id']; ?>">Invoice</a></td>
        </tr>
    <?php endforeach; ?>
    </tbody>
</table>
